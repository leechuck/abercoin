...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Abercoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"abercointools.com", "dnsseed.abercointools.com"},
    {"abercoinpool.org", "dnsseed.abercoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"abercointools.com", "testnet-seed.abercointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Abercoin is probably already running."), addrBind.ToString().c_str());
        else
