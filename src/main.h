...
static const unsigned int MAX_BLOCK_SIZE = 10000000;                      // 10MB block hard limit; increased to accommodate solution to optimization problem
...
static const int64 MAX_MONEY = 84000000 * COIN * 1000; // adjust by 1000 to allow for all blocks containing improved solution to optimization problem
...
public:
    ...
    unsigned int newMax; /* used to store the new global maximum of the optimization problem */
    unsigned int prevMax; /* global maximum of optimization problem from last block */
    uint256 hashMSA;
    unsigned int nTime;
    unsigned int nBits;
    unsigned int nNonce;
